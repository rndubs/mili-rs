...
pub use derived::{
    compute_magnitude, compute_node_acceleration, compute_node_displacement,
    compute_node_displacement_magnitude, compute_node_velocity, compute_principal_strain,
    compute_principal_stress, compute_stress_invariant, magnitude_primals, magnitude_spec,
    nodal_reference_from_coords, nodal_reference_from_query, node_acc_spec, node_disp_mag_spec,
    node_disp_primal, node_disp_spec, node_vel_spec, principal_strain_primals,
