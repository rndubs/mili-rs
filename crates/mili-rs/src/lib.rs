...
pub use derived::{
    compute_node_displacement, compute_node_displacement_magnitude, nodal_reference_from_coords,
    nodal_reference_from_query, node_disp_mag_spec, node_disp_primal, node_disp_spec,
};
#[doc(hidden)]
