...
pub use shell::{
    ...
    time_menu_items, BottomTab, CutPlaneState, CutThrottle, ElementSeries, ElementSeriesSample,
    LoadedInfo, Overlay, Overlays, RenderMode, ResultInfo, SessionPhase, ShellState, Theme,
    TimeSample, TranscriptKind, TranscriptLine, UiAction, CUT_GIZMO_COLOR, CUT_PREVIEW_INTERVAL,
    DERIVED_RESULTS, SLICE_GIZMO_COLOR,
};
pub use snapshot::{
