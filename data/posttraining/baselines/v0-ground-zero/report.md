...
**L3 pass rate: 0.020 (2.0%) — 1 / 50 scenarios.**

* provider: `llamacpp`
* model: `ggml-org/functiongemma-270m-it-GGUF:BF16`
* system_prompt_sha256: `77b3f0659b28bfd5`
...
* mean turns to completion: **6.50**
* total wall clock: **378374 ms** (378.37 s)
...
* rollouts: `../../data/posttraining/runs/v0-llamacpp-baseline/rollouts.jsonl`
* summary: `../../data/posttraining/runs/v0-llamacpp-baseline/summary.json`
* config: `../../data/posttraining/runs/v0-llamacpp-baseline/config.yaml`
