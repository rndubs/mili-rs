...
heavy providers (``TransformersProvider``, ``AnthropicProvider``,
``LlamaCppProvider``) live in their own modules and are imported on
demand by the CLI factory; tests pin this with a fresh-reload
``sys.modules`` check.
"""
